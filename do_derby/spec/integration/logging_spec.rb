...
describe DataObjects::Derby::Command, "logging" do

  before(:each) do
    @connection = DataObjects::Derby::Connection.new("jdbc:derby:testdb;create=true")
  end
  ...
  describe "Executing a Reader" do
    ...
    it "should log reader queries when the level is Debug (0)" do
      ...
      DataObjects::Derby.should_receive(:logger).and_return(@mock_logger)
