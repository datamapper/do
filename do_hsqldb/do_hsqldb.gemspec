...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<data_objects>, ["= 0.10.11"])
      s.add_runtime_dependency(%q<do_jdbc>, ["= 0.10.11"])
      s.add_runtime_dependency(%q<jdbc-hsqldb>, ["~> 1.8.0"])
      s.add_development_dependency(%q<rspec>, ["~> 2.5"])
      s.add_development_dependency(%q<rake-compiler>, ["~> 0.7"])
    else
      s.add_dependency(%q<data_objects>, ["= 0.10.11"])
      s.add_dependency(%q<do_jdbc>, ["= 0.10.11"])
